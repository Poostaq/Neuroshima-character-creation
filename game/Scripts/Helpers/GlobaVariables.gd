...
func _ready():
	...
	illness_mode = int(DatabaseOperations.get_config_value("illness_mode")["config_attribute_value"])
...
func save_config():
	...
	DatabaseOperations.save_config_value("illness_mode", str(illness_mode))
